...
var quiz_id = <%=request.getParameter("id")%>
	...
	var ws3 = new WebSocket(wsUrl + window.location.host + "/QuizPortal/SendQuestion");
...
<body>
	...
	<div
		...
		<h3>
			Go to QuizPortal/participate.jsp and use the code
